package vitoriamrfontana.integrationtests.controllers.withjson;

import vitoriamrfontana.config.TestConfigs;
import vitoriamrfontana.integrationtests.dto.PersonDTO;
...
class PersonControllerTest extends AbstractIntegrationTest {
    ...
    void createWithWrongOrigin() throws JsonProcessingException {
        ...
        specification = new RequestSpecBuilder()
                .addHeader(TestConfigs.HEADER_PARAM_ORIGIN, TestConfigs.ORIGIN_VICS)
                .setBasePath("/api/person/v1")
                .setPort(TestConfigs.SERVER_PORT)
                .addFilter(new RequestLoggingFilter(LogDetail.ALL))
                .addFilter(new ResponseLoggingFilter(LogDetail.ALL))
