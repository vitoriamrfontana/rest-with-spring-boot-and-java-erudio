...
public class EmailService {
    ...
    public void setEmailWithAttachment(String emailRequesJson, MultipartFile attachment){
        File tempFile = null;
        try {
            EmailRequestDTO emailRequest =  new ObjectMapper().readValue(emailRequesJson, EmailRequestDTO.class);
